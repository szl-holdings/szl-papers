...
- Λ-uniqueness taxonomy: *governance-safe* uniqueness is **Theorem U** (proven, conditional, axiom-free — unique *modulo* `≈Λ` under the Identifiability Assumptions, strict `=` only under `Anchored`/`Normalized`; [`Lutar/Uniqueness/TheoremU.lean`](https://github.com/szl-holdings/lutar-lean/blob/main/Lutar/Uniqueness/TheoremU.lean)); **Conjecture 1 is disproved as stated**, and only the weaker-condition uniqueness question remains open
